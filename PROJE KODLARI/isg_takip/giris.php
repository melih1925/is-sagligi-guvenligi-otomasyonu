...
if (isset($_GET['basarisiz'])) {
    echo '<div class="alert alert-danger text-center">Hatalı mail adresi veya şifre.</div>';
}
if (isset($_GET['dogrulama_gerekli'])) {
    echo '<div class="alert alert-warning text-center">Email adresinizi doğrulamanız gerekiyor.</div>';
}
?>
...
if (isset($_POST['girisyap'])) {
    ...
    if ($sonuc == 0) {
        ...
        exit;
    } elseif ($kullanici['email_verified'] == 0) {
        header("Location: giris.php?dogrulama_gerekli");
        exit;
    } else {
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-3">
                         <a href="sifremi_unuttum.php" class="btn btn-link">Şifremi Unuttum</a>
                        </div>
